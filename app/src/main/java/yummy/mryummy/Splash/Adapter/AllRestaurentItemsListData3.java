...
public class AllRestaurentItemsListData3 extends RecyclerView.Adapter<AllRestaurentItemsListData3.ViewHolder> {
    ...
    public AllRestaurentItemsListData3(Context context, List<ItemsDatum> itemsDatas,
    ...
    @Override
    public AllRestaurentItemsListData3.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View itemLayoutView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.restaurent_item_adapter_layout3, null);
        // create ViewHolder
        AllRestaurentItemsListData3.ViewHolder viewHolder = new AllRestaurentItemsListData3.ViewHolder(itemLayoutView);
        return viewHolder;
    }

    // Replace the contents of a view (invoked by the layout manager)
    @Override
    public void onBindViewHolder(final AllRestaurentItemsListData3.ViewHolder viewHolder, final int position) {
...
*/
        ...
        if (SingleRestaurentDetailActivity.counter3 == 0) {
        ...
        viewHolder.item_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SingleRestaurentDetailActivity.counter3 = SingleRestaurentDetailActivity.counter3 + 1;
                SingleRestaurentDetailActivity.prise3 = SingleRestaurentDetailActivity.prise3 + Integer.parseInt(viewHolder.item_price.getText().toString().replace(" \u20B9 ", ""));
                SingleRestaurentDetailActivity.selected_itemdata3.add(itemsDatas.get(position));
        ...
        viewHolder.sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SingleRestaurentDetailActivity.selected_itemdata3.remove(itemsDatas.get(position));
                viewHolder.display.setText(String.valueOf(Integer.parseInt(viewHolder.display.getText().toString()) - 1));
