...
public class AllRestaurentListAdapter extends RecyclerView.Adapter<AllRestaurentListAdapter.ViewHolder> {


    private List<Restaurantlist> restaurentsstatus;
    private List<RestaurantsDatum> restaurentdata;
    private Context context;

    public AllRestaurentListAdapter(Context context,List<RestaurantsDatum> restaurentdata) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
       ...
       /* viewHolder.restaurent_category.setText(restaurentdata.get(position).getCategories());
        ...
        /*Picasso.with(AllRestaurentsListActivity.mContext).load("http://openingsin.com/mryummy_admin/services/user/category.php?"
                + restaurentlists.get(position).getImage())
