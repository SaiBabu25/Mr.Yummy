...
public class AllRestaurentItemsListData extends RecyclerView.Adapter<AllRestaurentItemsListData.ViewHolder> {
...
*/
        ...
        if (SingleRestaurentDetailActivity.counter == 0) {
      ...
      /*  viewHolder.likeButton.setOnLikeListener(new OnLikeListener() {
        ...
        viewHolder.item_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SingleRestaurentDetailActivity.counter = SingleRestaurentDetailActivity.counter + 1;
                SingleRestaurentDetailActivity.prise = SingleRestaurentDetailActivity.prise + Integer.parseInt(viewHolder.item_price.getText().toString().replace(" \u20B9 ", ""));
                SingleRestaurentDetailActivity.selected_itemdata.add(itemsDatas.get(position));
        ...
        viewHolder.sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SingleRestaurentDetailActivity.selected_itemdata.remove(itemsDatas.get(position));
                viewHolder.display.setText(String.valueOf(Integer.parseInt(viewHolder.display.getText().toString()) - 1));
                SingleRestaurentDetailActivity singleRestaurentDetailActivity = new SingleRestaurentDetailActivity();
                singleRestaurentDetailActivity.snackbar(v, context, d_charges);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemLayoutView) {
            ...
            //  likeButton = (LikeButton) itemLayoutView.findViewById(R.id.likeButton);
